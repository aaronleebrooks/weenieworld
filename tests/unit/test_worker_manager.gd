...
func test_get_workers_by_assignment():
	...
	# Test filtering
	var kitchen_workers = worker_manager.get_workers_by_assignment(WorkerDefinition.WorkerAssignment.KITCHEN)
	var office_workers = worker_manager.get_workers_by_assignment(WorkerDefinition.WorkerAssignment.OFFICE)
